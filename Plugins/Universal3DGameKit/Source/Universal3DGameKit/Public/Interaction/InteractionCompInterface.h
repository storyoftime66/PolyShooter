...
#include "InteractionCompInterface.generated.h"

// This class does not need to be modified.
UINTERFACE()
class UNIVERSAL3DGAMEKIT_API UInteractionCompInterface : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 交互组件接口
 */
class UNIVERSAL3DGAMEKIT_API IInteractionCompInterface
{
	GENERATED_BODY()
